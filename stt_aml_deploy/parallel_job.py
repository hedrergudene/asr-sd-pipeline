...
def main(
    ...
    pipeline_job = stt_batch(
        ...
        aml_cpu_cluster = config_dct['aml']['computing']['aml_cpu_cluster'],
        aml_t4_cluster = config_dct['aml']['computing']['aml_t4_cluster'],
        aml_a100_cluster = config_dct['aml']['computing']['aml_a100_cluster'],
