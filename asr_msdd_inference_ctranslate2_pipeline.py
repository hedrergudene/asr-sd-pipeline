...
def main(
    ...
    asr_inference_ctranslate2_comp = load_component(source="./components/asr_inference_ctranslate2/asr_inference_ctranslate2.yaml")
    ...
    def asr_msdd_inference_ctranslate2_pipeline():
        ...
        # ASR
        asr_inference_ctranslate2_node = asr_inference_ctranslate2_comp(
        ...
        asr_inference_ctranslate2_node.compute = config_dct['azure']['computing']['gpu_cluster_aml_id']

        # MSDD
        diarize_inference_node = diarize_inference_comp(
            input_path=read_data_node.outputs.output_path,
            input_transcriptions = asr_inference_ctranslate2_node.outputs.output_path,
        ...
        merge_align_node= merge_align_comp(
            input_asr_path=asr_inference_ctranslate2_node.outputs.output_path,
    ...
    # Create a pipeline
    pipeline_job = asr_msdd_inference_ctranslate2_pipeline()
